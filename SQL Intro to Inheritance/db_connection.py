...
userID: str = '028691037' #input('User ID [postgres]--> ') or "postgres"
...
password: str = '58zzwlJm' #getpass.getpass(prompt=userID + ' password--> ')
host: str = 'CECS-Postgresql' #input('hostname [CECS-Postgresql]--> ') or "CECS-Postgresql"
